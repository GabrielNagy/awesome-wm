...
run_once({ "urxvtd", "unclutter -root", "xset -b", "xset r rate 300 50" }) -- entries must be separated by commas
...
local scrlocker    = "i3lock -e -f -c 1d2021"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "Insert", function () awful.spawn.with_shell("showclip") end,
              {description = "show clipboard contents", group = "hotkeys"}),
